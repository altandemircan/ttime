...
function createScaleElements(track, widthPx, spanKm, startKmDom, markers = [], customElevData = null, retryCount = 0) {
  ...
  let gridLabels = [];
  if (customElevData && customElevData.vizMin !== undefined && customElevData.vizMax !== undefined) {
      ...
      <div class="scale-bar-track">
        <div class="elevation-placeholder">
          <div class="tt-scale-loader">
            ...
            <div style="color: #6c757d; font-size: 14px;">Loading elevation</div>
          </div>
        </div>
      </div>
    `;
  ...
  window.showScaleBarLoading = function(c, t='Loading elevation…', day=null, sKm=null, eKm=null){
    ...
    if (!placeholder) {
      ...
      placeholder.innerHTML = `
        <div class="tt-scale-loader" style="display: flex; flex-direction: column; align-items: center; gap: 12px;">
          <div class="spinner"></div>
          <div class="txt">${t}</div>
        </div>
