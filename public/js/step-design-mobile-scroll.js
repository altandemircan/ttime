...
function injectDropdownStyles() {
    ...
    style.textContent = `
        ...
        /* === MOBİL FULL-SCREEN GÜN KAYDIRMASI (BOŞLUKSUZ) === */
        @media (max-width: 768px) {
            /* Chat box / resultat container'ı full-height yap */
            .survey-results {
                height: 100vh;
                overflow: hidden;
                display: flex;
            ...
            /* Accordion list tam ekran scroll-snap */
            .accordion-list {
                height: 100vh;
                overflow-y: scroll;
                overflow-x: hidden;
            ...
            /* Splide tam container'ı kaplasın */
            .splide {
                height: 100%;
                flex: 1;
                margin: 0;
...
(function initMobileFullScreenDays() {
    ...
    // DOM yüklendiğinde ve resize'da çalıştır
    if (document.readyState === 'loading') {
