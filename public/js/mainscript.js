...
// item'ı ve sonrasını kontrol et
const hasNextLoc =
  item.location &&
...
if (hasNextLoc) {
  ...
  // Travel mode debug!
  console.log("SEPARATOR travelMode=", travelMode, "day:", day);

  if (travelMode === "fly") {
    // SADECE FLY MODDA add!
    ...
    // Diğer modlara route API summary veya fallback
    ...
    autoGeneratedStr = ''; // FLY DEĞİLSE BOŞ OLACAK!
  }
console.log("SEPARATOR travelMode=", travelMode, "day:", day, "item:", item?.name);
