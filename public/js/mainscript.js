...
function createLeafletMapForItem(mapId, lat, lon, name, number, day) {
    ...
    const fallbackHtml = `
  <div class="custom-marker-outer red" style="transform: scale(0.7); display:flex; align-items:center; justify-content:center;">
...
marker.bindPopup(`<b>${name || 'Point'}</b>`, {
    closeButton: false,
    offset: [6, -16] // X:0 (Yatayda tam orta), Y:-16 (İkonun tam tepesi)
}).openPopup();
