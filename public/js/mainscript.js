...
// Her item arası separatorda travelMode'a göre autoGeneratedStr ekle!
...
// Travel mode (Küçük harf ve trim ile kesin eşleştir!)
const travelMode =
...
if (hasNextLoc) {
  ...
  if (travelMode === "fly") {
    // SADECE FLY MODDA "auto generated" yaz!
    ...
    // CAR, BIKE, WALK modunda summary ile veya fallback
    ...
    autoGeneratedStr = ''; // DİĞER MODDA ASLA!
  }

  // DOM'a separator ekle
