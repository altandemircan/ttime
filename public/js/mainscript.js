...
async function renderRouteForDay(day) {
    ...
    // MARKER / SCALE BAR İÇİN HESAPLAMALAR
    ...
    if (isInTurkey && routeData) {
        ...
        const summary = { distance: acc, duration: acc / 13 };
