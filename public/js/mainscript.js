  ...
  layerOptions.forEach(opt => {
    ...
    div.onclick = function(e) {
      ...
      if (opt.value === 'liberty') {
        ...
        // 5. TEK TILE ÇÖZÜMÜ: 300ms SONRA STİLİ TEKRAR SEÇTİRİYORUZ (RE-TRIGGER)
        // Sanki kullanıcı butona tekrar basmış gibi haritayı zorla yeniliyoruz.
        requestAnimationFrame(() => {
            setTimeout(() => {
                // A. Boyut güncelle
                expandedMapInstance.invalidateSize(false);
                
                // B. Stili (Tile Layer) tekrar yükle - Bu işlem gri alanı doldurur
                setExpandedMapTile(opt.value);
            ...
            }, 300); // 300ms sonra tekrar tetikle
        });
      }
