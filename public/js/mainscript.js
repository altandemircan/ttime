...
async function renderRouteForDay(day) {
    ...
    // --- GPS / RAW TRACK KONTROLÜ (MEVCUT KODUNUZ) ---
    ...
    // --- MARKER POSITIONS HESABI (MARKER KAYMASINI ÖNLER) ---
    // Bu kısım, markerların mesafesini doğru hesaplayıp "sola toplanma" sorununu çözer.
