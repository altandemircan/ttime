...
async function insertTripAiInfo() {
    ...
    try {
        ...
        while (true) {
            ...
            // Satır satır işle, JSON'ları ayrıştır
            ...
            for (const line of lines) {
                ...
                try {
                    ...
                    if (obj.response) {
                        ...
                        aiContent.textContent += obj.response;
                    }
                } catch {}
            }
        }

        // Son kalan buffer'daki satırı da işle
        if (buffer.trim()) {
            try {
        ...
        // fullText artık tüm JSON çıktısı (ör: {"summary":"...","tip":"...","highlight":"..."} )
        // Bunu parse edip alanlara bölebilirsin:
        ...
        try {
            ...
            // JSON parse hatası varsa regex ile ayıkla
