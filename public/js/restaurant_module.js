...
async function showNearbyPlacesPopup(lat, lng, map, day, radius = 500) {
    ...
    const categoryGroups = {
        ...
        "cafes": "catering.cafe",
        "entertainment": "leisure.park,entertainment.cinema,entertainment"
    };
    ...
    try {
        ...
        Object.keys(categorizedPlaces).forEach(key => {
            ...
            if (places.length === 0) {
                ...
                places.forEach((place, index) => {
                    ...
                    // İkon seçimi kategoriye göre
                    let icon = "📍";
                    if (key === 'restaurants') icon = "🍽️";
                    else if (key === 'hotels') icon = "🏨";
                    else if (key === 'cafes') icon = "☕";
                    else if (key === 'entertainment') icon = "🎭";
                    ...
                    tabContentsHtml += `
                        <div class="category-place-item" 
                            ...
                            <div style="width: 40px; height: 40px; flex-shrink: 0; 
                                        ...
                                        background: #fff; border-radius: 6px; font-size: 20px;">
                                ${icon}
                            </div>
                            <div style="flex: 1; min-width: 0;">
        ...
        // Tıklanan nokta için AI açıklama
        loadClickedPointImage(pointInfo.name);
        
        // Tab değiştirme işlevselliği ekle
        setTimeout(() => {
