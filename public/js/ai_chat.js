document.addEventListener("DOMContentLoaded", function() {
    ...
    if (!document.getElementById(styleId)) {
        const css = `
            /* --- 1. ANA KUTU İÇ DÜZENİ --- */
            /* BURADA POSITION:FIXED YOK! Açılışta gelmez. */
            #sidebar-login {
                ...
                max-height: 100dvh !important; /* Mobil bar uyumu */
            }

            /* --- 2. KAPSAYICILARIN YAPISI --- */
            /* Inputun aşağıda durması için flex yapısı */
            .form-container {
                flex: 1 !important;
                display: flex !important;
                flex-direction: column !important;
            ...
            /* Mesaj divlerinin margin sorununu çöz */
