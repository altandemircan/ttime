document.addEventListener("DOMContentLoaded", function() {
    ...
    // --- 2. CSS STYLES (SADECE İÇ HİZALAMAYI DÜZELTEN GÜVENLİ CSS) ---
    const styleId = 'tt-ai-sidebar-styles';
    if (!document.getElementById(styleId)) {
        const css = `
            /* --- 1. ANA KUTU (POZİSYONA KARIŞMIYORUZ) --- */
            /* Burada position:fixed YOK. Böylece açılışta gizli kalır. */
            #sidebar-login {
                ...
                padding: 0 !important;
                /* Mobilde tarayıcı barı sorunu için max-height: 100dvh */
                max-height: 100dvh !important;
            }

            /* --- 2. İÇERİK KAPSAYICILARI (FLEX DÜZENİ) --- */
            /* İçeriğin taşmasını engeller ve inputu alta iter */
            .form-container {
                flex: 1 !important;
                display: flex !important;
                flex-direction: column !important;
            ...
            /* Mesaj divlerinin içindeki margin sorununu çöz */
            ...
            .ai-input-wrapper {
                ...
                /* iPhone Safe Area (Siyah çizgi payı) */
